...
$(function () {
    ...
    */
    ...
    describe('The menu', function () {
         ...
         */
        it('check display and hidden', function() {

            expect(document.getElementsByTagName("body")[0].classList.contains('menu-hidden')).toEqual(true);
            $('body').trigger('click');
            expect(document.getElementsByTagName("body")[0].classList.contains('menu-hidden')).toEqual(true);
        });
    });
     ...
     */
    it('check if 1 entry is defined', function() {
    ...
    let firstfeed, secondfeed; 
     ...
     it('check if feeds are different', function() {
